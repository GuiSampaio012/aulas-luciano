...
from . import models
from vendas.models import PedidosItens, Pedidos
...
class ProdutoAdmin(admin.ModelAdmin):
    list_display = ['nome','preco','qtd','categoria','avaliar_estoque','validade','disponibilidade']
    ...
    def save_formset(self, request, form, formset, change):
        ...
        for obj in instances:
            ...
            if obj.qtd > obj.fk_produtos.qtd:
              self.message_user(request,'A quantidade de produtos é menor do que a pedida', messages.error )
            else:
                obj.fk_produtos.qtd -= obj.qtd        
            obj.save()
